...
public class ServiceManager : IServiceManager
{
    ...
    private readonly Lazy<IFireworksService> _fireworksService;
    ...
    public ServiceManager(IRepositoryManager repositoryManager, ILoggerManager logger, IMapper mapper)
    {
        ...
        _fireworksService = new Lazy<IFireworksService>(() => new FireworksService(logger: logger, mapper: mapper, repository: repositoryManager));
    }

    public IFireworksService FireworksService => _fireworksService.Value;
