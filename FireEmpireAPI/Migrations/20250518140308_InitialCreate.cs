    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventProductUsages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventProductUsages_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EventProductUsages_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EventProductUsages_Warehouses_WarehouseId",
            ...
            migrationBuilder.InsertData(
                table: "Contacts",
                columns: new[] { "Id", "BirthDay", "CreatedAt", "JobTitle", "MobilePhone", "Name", "UpdatedAt" },
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), new DateTime(1992, 9, 30, 0, 0, 0, 0, DateTimeKind.Utc), "Менеджер", "+375291112233", "Иван Иванов", null },
                    { new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(1995, 5, 15, 0, 0, 0, 0, DateTimeKind.Utc), new DateTime(1992, 9, 30, 0, 0, 0, 0, DateTimeKind.Utc), "Разработчик", "+375293334455", "Ольга Смирнова", null },
                    { new Guid("33333333-3333-3333-3333-333333333333"), new DateTime(1992, 9, 30, 0, 0, 0, 0, DateTimeKind.Utc), new DateTime(1992, 9, 30, 0, 0, 0, 0, DateTimeKind.Utc), "Тестировщик", "+375297778899", "Петр Сидоров", null }
                });

            migrationBuilder.CreateIndex(
                name: "IX_EventProductUsages_EventId",
                table: "EventProductUsages",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_EventProductUsages_ProductId",
                table: "EventProductUsages",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_EventProductUsages_WarehouseId",
                table: "EventProductUsages",
                column: "WarehouseId");
